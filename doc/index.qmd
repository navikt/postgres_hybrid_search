...
[ligning @eq-rang] tar vi hensyn til at et treff ikke nødvendigvis finnes i alle
søk, og vi summerer deretter de forskjellige rangeringene til én endelig
sum ($score$) i [ligning @eq-rrf]. Denne summen kan så brukes for sortering for
å fine endelig rangering.
